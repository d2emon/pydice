...
class Dice:
    def __init__(self, count=1, max_value=6, min_value=1, modifier=0, multiplier=1):
        self.count = count
    ...
    def roll(self):
        for _ in range(self.count):
            self.value = random.randint(self.min_value, self.max_value) * self.multiplier + self.modifier
